...
export function parseNumber(input: string, default_value?: number): number {
    let str = input;
...
export class Console {
    ...
    disasm_cmd_last_address: number;
    disasm_cmd_last_length: number;
