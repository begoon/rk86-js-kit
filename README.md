...
> **Внимание:** репозиторий заархивирован. Его содержимое объединено с оригинальным эмулятором в репозитории [begoon/rk86-js](https://github.com/begoon/rk86-js). Дальнейшая разработка ведётся там.
