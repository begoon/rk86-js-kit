...
import { Console, parseNumber } from "../rk86_console.js";
...
test("Console.disasm_print", () => {
    ...
    const console = new Console({ memory });

    const output = [];
    console.term = {
        writeln: (msg) => output.push(msg),
    };

    console.disasm_print(0x0000, 3, 1);
